...
VALUES
    ...
    ('Armas y Exmilitar', 'Un cargamento de armas y, además, un exmilitar con traumas de guerra y malhumorado.', 'img/ArmasExmilitar.png', -10, -10, 0, 40),

    -- 11. Químico Políglota
    ('Químico Políglota', 'Un químico, junto a sus utensilios, con pocas habilidades sociales y que huele un pelín mal. Hay que mencionar que además es políglota, habla doce idiomas.', 'img/quimicoPoliglota.png', 0, -5, 15, 35),
    ...
    ('Profesores', 'Un profesor de arte y una profesora de matemáticas, cada uno con sus libros. Creemos que mantienen una relación en secreto, o eso se rumorea en el colegio del que vienen.', 'img/Profesores.png', 5, 15, 30, 5),

    -- 16. Drogas Ilimitadas
    ('Drogas Ilimitadas', 'Drogas, de todo tipo. Cantidad ilimitada.', 'img/drogasIlimitadas.png', -30, 65, -10, -15),

    -- 17. 2º Mejor Físico NASA
    ('2º Mejor Físico NASA', 'El segundo mejor físico de la NASA. Su enfoque innovador y técnicas personalizadas ayudarán a tu tripulación a mantener la calma y la concentración en el espacio profundo.', 'img/SegundoFisicoNASA.png', 0, 5, 30, 35),

    -- 18. Peor Físico NASA
    ('Peor Físico NASA', 'El peor físico de la NASA, de hecho, estuvo a punto de ser despedido por su bajo rendimiento. Se rumorea que es hijo del segundo mejor físico de la NASA. Es simpático pero está en muy mala forma.', 'img/peorFisicoNASA.png', 0, 15, 0, -5),

    -- 19. Internet
    ('Internet', 'Internet. No ocupa ningún hueco en la nave, no te preocupes, puedes escogerlo libremente.', 'img/Internet.png', -5, -30, 30, 20),
